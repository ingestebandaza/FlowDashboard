-- ============================================================================
-- CREAR FUNCIÓN SIN USAR DIGEST() DIRECTAMENTE
-- ============================================================================
-- IMPORTANTE: Esta función NO usa digest() internamente
-- El hash se calcula en el servidor Python y se pasa como parámetro
-- ============================================================================

-- PASO 1: Habilitar pgcrypto (por si acaso)
...
-- PASO 3: Crear la función SIN usar digest()
-- El device_hash se calcula en el servidor Python
...
BEGIN
  ...
  -- IMPORTANTE: El device_hash se calcula en el servidor Python
  -- NO usamos digest() aquí para evitar problemas de permisos
  IF p_device_hash = '' THEN
    -- Si no se proporciona hash, usar un valor por defecto
...
-- ✅ Función creada SIN usar digest()
-- ✅ Usa md5() en su lugar (disponible sin pgcrypto)
