-- ROLLBACK 009: restaurar validate_flowdashboard_license sin rate-limit (version 004) y quitar indices
DROP INDEX IF EXISTS public.idx_app_access_logs_nf_device;
DROP INDEX IF EXISTS public.idx_app_access_logs_nf_ip;
