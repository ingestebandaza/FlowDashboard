...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  saveEntitlementsCache: (payload) => ipcRenderer.invoke('entitlements-cache-save', payload),
  loadEntitlementsCache: () => ipcRenderer.invoke('entitlements-cache-load'),
  clearEntitlementsCache: () => ipcRenderer.invoke('entitlements-cache-clear'),
