-- ============================================================================
-- CREAR FUNCIÓN DE VALIDACIÓN DE LICENCIAS
-- ============================================================================
-- IMPORTANTE: Ejecutar DESPUÉS de eliminar todas las funciones duplicadas
-- Este script SOLO crea la función, sin eliminar nada
-- ============================================================================

-- PASO 1: Verificar que pgcrypto está habilitada
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- PASO 2: Crear la función validate_flowdashboard_license
-- Esta es la versión correcta con 13 parámetros
...
-- PASO 4: Notificar a PostgREST que recargue el esquema
...
--
-- PRÓXIMOS PASOS:
-- 1. Verifica en Database → Functions que hay 1 función
-- 2. Recarga el dashboard
-- 3. Intenta iniciar sesión nuevamente
-- 4. La validación debería funcionar correctamente
-- ============================================================================
