...
REQUIRED_SERVER_FEATURES = {"static_dashboard", "client_info", "license_remember", "adb_path_probe", "client_network_info", "adb_diagnostics", "visual_update_check", "bundled_flowagent_apk", "device_categories", "device_visible_ip", "flowagent_socket_app_info_permissions", "flowagent_accessibility_diagnostics"}
